...
SELECT * FROM tickets WHERE passenger_name LIKE '%IRINA%'; -- He tenido que buscar en internet cómo introducir un substring en la condición porque no lo encontraba en los apuntes
